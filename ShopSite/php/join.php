...
<body style="background-color: #f5f6f7;">
    ...
    <div class="">
        <div class="row">
            ...
            <!-- 내용을 넣을 DIV -->
            <div class="col">
                <!-- form 태그가 실행되면 getdata()
                index.html 액션을하는데,
                방법이 get -->
             


                <form name="form" action="../back/signup.php" onsubmit="" method="post"> 
                <div style="padding: 8px;">
                    <h3 style="text-align: left;">아이디</h3>                                        
                    <input maxlength="10" id="uid" name="uid"
                ...
                <div style="padding: 8px;">
                    ...
                    <input maxlength="16" id="pw" name="pw" class="form-control" 
                    type="password" 
                    onkeyup="chkpw()"                    
                    >                                            
                ...
                <div style="padding: 8px;">
                    ...
                    <span id="names" style="color: red; display: none;">
                        필수 정보 입니다.
                    </span>                    
                </div>
                <div style="padding: 8px;">
                    ...
                    <input name="location" class="form-control" type="text" 
                     id = "addr" readonly
                     onclick="postcode()">   
                    <span id="addrs" style="color: red; display: none;">
                    필수 정보 입니다.
                    </span>                    
                </div>
                <div style="padding: 8px;">
                    ...
                    maxlength="6" placeholder="생년월일6자" 
                    onkeyup="chkbirth()">                                            
                    <span id="births" style="color: red; display: none;">
                        필수 정보 입니다.
                    </span>                    
                </div>
                <div style="padding: 8px;">
                ...
                <div style="padding: 8px;">
                    ...
                    <span id="emails" style="color: red; display: none;" >
                        필수 정보 입니다.
                    </span>                                                             
                </div>                
                <div>
                    <button onclick="" class="btn btn-lg btn-primary" style="width: 100%;">
                        가입하기</button>
                </div>
                </form>
            </div>
...
if (alertTrigger) {
  alertTrigger.addEventListener('click', function () {
    ...
    function chkemail() {
        var emailRE = /[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*@[0-9a-zA-Z]([-_.]?[0-9a-zA-Z])*.[a-zA-Z]$/i;
